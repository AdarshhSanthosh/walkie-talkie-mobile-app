...
- **Phase 6** done: real in-app notifications + preferences (device push delivery pending a Firebase project — see below).
...
| Notifications: friend request/accept, channel-join alerts, read/unread inbox | ✅ Real (Supabase Postgres + RPCs), generated by the Phase 3/4 actions above |
...
Phase 6 is written and analyzed against the same live project, pending a
live run-through — see "Next steps".
